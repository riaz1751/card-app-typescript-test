...
server.post<{ Body: Entry }>("/create/", async (req, reply) => {
  ...
  newEntryBody.created_at
   ...
   newEntryBody.schedule_at
     ? (newEntryBody.schedule_at = new Date(req.body.schedule_at))
     : (newEntryBody.schedule_at = new Date());
  try {
  ...
  async (req, reply) => {
    ...
    updatedEntryBody.created_at
      ...
      : (updatedEntryBody.created_at = new Date());
       updatedEntryBody.schedule_at
       ? (updatedEntryBody.schedule_at = new Date(req.body.schedule_at))
       : (updatedEntryBody.schedule_at = new Date());
    try {
